function openLink() {
    window.open('https://api.whatsapp.com/send?phone=79532027785&text=!help', '_blank')
}
function openIg() {
    window.open('https://www.instagram.com/dxd.darkness', '_blank')
}
function openGroup() {
    window.open('https://chat.whatsapp.com/LTGxxBqjeK86ByvSEdafDR', '_blank')
}
function openOwner() {
	window.open('https://api.whatsapp.com/send?phone=6285938633653&text=Halo owner Darkness-Bot', '_blank')
}
function openEvent() {
	window.open('https://api.whatsapp.com/send?phone=79532027785&text=!event', '_blank')
}
function openBackup() {
